...
public class SysLogController extends AbstractController {
	private final SysLogService SysOperationlogService;
	...
	public R list(@RequestParam Map<String, Object> params){
		...
		IPage<SysLog> SysOperationlogList = SysOperationlogService.page(mpPageConvert.<SysLog>pageParamConvert(params),queryWrapper);
		return R.ok().put("page", mpPageConvert.pageValueConvert(SysOperationlogList));
	}
