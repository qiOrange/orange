...
import com.orange.modules.gen.entity.ColumnEntity;
import com.orange.modules.gen.entity.GenConfig;
import com.orange.modules.gen.entity.InfoRmationSchema;
import com.orange.modules.gen.entity.TableEntity;
...
public class GenUtils {
    ...
    public void generatorCode(GenConfig genConfig,InfoRmationSchema table, List<ColumnEntity> columns, ZipOutputStream zip) {
        ...
        mainPath = StringUtils.isBlank(mainPath) ? "com.orange" : mainPath;
        //封装模板数据
    ...
    public String getFileName(String template, String className, String packageName, String moduleName) {
        ...
        if (template.contains("list.html.vm" )) {
            return "orange-springboot-ui" + File.separator + "modules" + File.separator + moduleName + File.separator + className.toLowerCase() + ".html";
        }

        if (template.contains("list.js.vm" )) {
            return "orange-springboot-ui" + File.separator + "js" + File.separator + "modules" + File.separator + moduleName + File.separator + className.toLowerCase() + ".js";
        }
